<template>
    <div class="w-full flex justify-center flex-col bg-white rounded-lg py-5 mt-5">
        ...
        <div class="w-full flex justify-center">
            <table class="w-95%  border-gray-300 text-gray-500 ">
                    <tr>
                        <td>ID</td>
                        <td>Unit</td>
                        <td>Owner</td>
                ...
                <tbody class="blur-sm">
                    ...
                    <tr>
                        ...
                        <td>Kim Chung</td>
                        <td>No data</td>
                        <td class="text-Custom-Blue">Relations</td>
                        <td>No data</td>
                        <td>No data</td>
                        <td class="text-Custom-Blue">Relations</td>
...
import WarnButton from '../buttons/WarnButton.vue';
</script>
